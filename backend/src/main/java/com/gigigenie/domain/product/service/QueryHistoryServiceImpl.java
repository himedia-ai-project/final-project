...
public class QueryHistoryServiceImpl implements QueryHistoryService {
    ...
    @Override
    public void save(HistoryRequest request, Authentication authentication) {
    ...
    @Override
    public void deleteByMemberAndProduct(Long productId, Authentication authentication) {
        Member member = findMember(authentication);
        Product product = findProduct(productId);
